...
const TOPIC_PRIORITY_HIGH: string[] = [
  ...
  "q5", // 報酬額の制限
  "q35", // 住宅瑕疵担保履行法(範囲が狭いのに毎年ほぼ確実に1問。コスパ最強枠)
  "q94", // 犯罪収益移転防止法(取引時確認等)。直近改正・新傾向の論点で今後も出る可能性がある
  "q33", // 事務所・案内所の規制(5点セット。組み合わせ・個数問題の定番)
  "q38", // 従業者証明書・名簿・帳簿・標識(5点セットの一部)
  "q75", // 従業者名簿の記載事項・標識の様式(5点セットの一部)
  ...
  "q9", // 建蔽率・容積率(zenshi)
  "q10", // 容積率(calc)
  "q47", // 建築確認(2025年4月改正の木造/非木造区分撤廃でひっかけ問題として狙われやすい)
