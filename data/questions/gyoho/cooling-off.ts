...
export const coolingOff: Question = {
  ...
  source: {
    level: "primary",
    answerLevel: "primary",
    note: "肢1=37条の2第1項(事務所での申込みは「事務所等」に当たり対象外)/肢2=施行規則16条の6(告知は書面を交付して行う→口頭では8日は起算しない)/肢3=37条の2第1項2号(引渡しを受け「かつ」代金の全部を支払つたとき)/肢4=施行規則16条の5第1号ロ・ニ(案内所は「土地に定着する建物内に設けられるものに限る」=テント張りは事務所等でない)を条文原文で確認。解除の効力発生=37条の2第2項(書面を発した時)。gyoho-verification.md #138 塊C 参照",
  },
  lawVersion: {
    ...
    note: "本則(37条の2)は上記版、事務所等・告知の施行規則16条の5・16条の6は 332M50004000012_20260401_507M60000802002。いずれも施行日が試験の法令基準日(令和8年4月1日)と一致するため差分は生じない",
  },
  category: "宅建業法",
  topic: "クーリングオフ",
